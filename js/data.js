...
/* ---------------- species data ---------------- */
/* bloom: months 4-10; peak months in `peak`. yearsToFlower = min years to flower.
   colonizer: 'aggressive' | 'spreading' | null. zone: climax|buffer|colonizer|general */
const SPECIES = [
 {id:"crocus",common:"Prairie Crocus",sci:"Anemone patens",color:"purple",bloom:[4,5,6],peak:[5],peakText:"Mid-April\u2013June",dur:6,minHeightCm:15,maxHeightCm:30,minSpreadCm:15,maxSpreadCm:20,yearsToFlower:3,yearsToFlowerText:"3\u20137 years",attr:["bee"],nfix:false,colonizer:null,zone:"climax",feed:"lean",moist:"dry",benefit:"First nectar of the year; vital pollen for emerging queen bees."},
 {id:"blueeyed",common:"Blue-Eyed Grass",sci:"Sisyrinchium montanum",color:"blue",bloom:[5,6,7],peak:[6],peakText:"May\u2013July",dur:4,minHeightCm:10,maxHeightCm:50,minSpreadCm:10,maxSpreadCm:20,yearsToFlower:2,yearsToFlowerText:"2 years",attr:["bee"],nfix:false,colonizer:null,zone:"general",feed:"adaptable",moist:"mesic",benefit:"Star-shaped blooms for small native bees and syrphid flies."},
 {id:"avens",common:"Three-Flowered Avens",sci:"Geum triflorum",color:"pinkred",bloom:[5,6,7],peak:[6],peakText:"May\u2013July",dur:8,minHeightCm:15,maxHeightCm:45,minSpreadCm:30,maxSpreadCm:45,yearsToFlower:2,yearsToFlowerText:"2\u20133 years",attr:["bee"],nfix:false,colonizer:null,zone:"general",feed:"lean",moist:"dry",benefit:"High-value early nectar; smoke-like pink seed plumes."},
 {id:"bedstraw",common:"Northern Bedstraw",sci:"Galium boreale",color:"white",bloom:[6],peak:[6],peakText:"June",dur:4,minHeightCm:30,maxHeightCm:90,minSpreadCm:30,maxSpreadCm:60,yearsToFlower:1,yearsToFlowerText:"1\u20132 years",attr:["bee"],nfix:false,colonizer:"spreading",zone:"general",feed:"adaptable",moist:"moist",benefit:"Dense white clusters draw predatory insects; spreads by rhizome + seed into patches."},
 {id:"anemone",common:"Long-Fruited Anemone",sci:"Anemone cylindrica",color:"white",bloom:[5,6],peak:[6],peakText:"Late May\u2013June",dur:4,minHeightCm:30,maxHeightCm:75,minSpreadCm:25,maxSpreadCm:45,yearsToFlower:2,yearsToFlowerText:"2 years",attr:["bee"],nfix:false,colonizer:null,zone:"general",feed:"lean",moist:"dry",benefit:"Woolly seed heads give native bees nesting material."},
 {id:"alumroot",common:"Alumroot",sci:"Heuchera richardsonii",color:"white",bloom:[6,7],peak:[6],peakText:"June\u2013July",dur:6,minHeightCm:30,maxHeightCm:90,minSpreadCm:30,maxSpreadCm:45,yearsToFlower:2,yearsToFlowerText:"2 years",attr:["hummingbird","bee"],nfix:false,colonizer:null,zone:"climax",feed:"humus",moist:"mesic",benefit:"Airy beige-pink spikes attractive to hummingbirds; foliage stays low, bloom stalks reach ~90 cm."},
 {id:"hedysarum",common:"Hedysarum",sci:"Hedysarum boreale",color:"pinkred",bloom:[6,7],peak:[6],peakText:"June\u2013July",dur:6,minHeightCm:30,maxHeightCm:60,minSpreadCm:25,maxSpreadCm:30,yearsToFlower:2,yearsToFlowerText:"2\u20133 years",attr:["butterfly","bee"],nfix:true,colonizer:null,zone:"general",feed:"lean",moist:"dry",benefit:"Nitrogen-fixing legume and host plant for butterfly larvae."},
 {id:"yarrow",common:"Yarrow",sci:"Achillea millefolium",color:"white",bloom:[6,7,8,9],peak:[6,7,8,9],peakText:"June\u2013September",dur:12,minHeightCm:30,maxHeightCm:90,minSpreadCm:45,maxSpreadCm:90,yearsToFlower:1,yearsToFlowerText:"1\u20132 years",attr:["bee"],nfix:false,colonizer:"aggressive",zone:"colonizer",feed:"adaptable",moist:"mesic",benefit:"Long bloom for parasitic wasps and native bees - but spreads hard by rhizome (colony-forming)."},
 {id:"harebell",common:"Harebell",sci:"Campanula rotundifolia",color:"purple",bloom:[6,7,8,9],peak:[6,7,8,9],peakText:"June\u2013September",dur:12,minHeightCm:10,maxHeightCm:50,minSpreadCm:20,maxSpreadCm:30,yearsToFlower:2,yearsToFlowerText:"2 years",attr:["bee"],nfix:false,colonizer:null,zone:"general",feed:"lean",moist:"dry",benefit:"Nodding bells specialised for bumblebees; blooms for months."},
 {id:"hyssop",common:"Giant Hyssop",sci:"Agastache foeniculum",color:"purple",bloom:[6,7,8,9],peak:[6,7,8,9],peakText:"June\u2013September",dur:12,minHeightCm:60,maxHeightCm:120,minSpreadCm:30,maxSpreadCm:90,yearsToFlower:1,yearsToFlowerText:"1 year",attr:["bee","butterfly","hummingbird"],nfix:false,colonizer:null,zone:"buffer",feed:"lean",moist:"mesic",benefit:"Exceptionally high nectar sugar; heavily visited; flowers in year one."},
 {id:"flax",common:"Wild Blue Flax",sci:"Linum lewisii",color:"blue",bloom:[7,8],peak:[7,8],peakText:"July\u2013August",dur:8,minHeightCm:30,maxHeightCm:80,minSpreadCm:45,maxSpreadCm:60,yearsToFlower:1,yearsToFlowerText:"1\u20132 years",attr:["bee"],nfix:false,colonizer:null,zone:"general",feed:"lean",moist:"dry",benefit:"Fresh periwinkle blooms daily; key for short-tongued bees."},
 {id:"primrose",common:"Yellow Evening Primrose",sci:"Oenothera biennis",color:"yellow",bloom:[6,7,8,9],peak:[7,8],peakText:"June\u2013September",dur:12,minHeightCm:60,maxHeightCm:180,minSpreadCm:30,maxSpreadCm:60,yearsToFlower:2,yearsToFlowerText:"Biennial (2 yr)",attr:["moth"],nfix:false,colonizer:null,zone:"general",feed:"adaptable",moist:"mesic",benefit:"Night-blooming; relies on sphinx moths for pollination."},
 {id:"milkweed",common:"Showy Milkweed",sci:"Asclepias speciosa",color:"pinkred",bloom:[6,7,8],peak:[7],peakText:"June\u2013August",dur:8,minHeightCm:60,maxHeightCm:150,minSpreadCm:30,maxSpreadCm:60,yearsToFlower:2,yearsToFlowerText:"2 years",attr:["butterfly","bee"],nfix:false,colonizer:"spreading",zone:"general",feed:"adaptable",moist:"mesic",benefit:"Primary larval host for the Monarch butterfly; spreads moderately by rhizome into colonies."},
 {id:"redlily",common:"Western Red Lily",sci:"Lilium philadelphicum",color:"pinkred",bloom:[7,8],peak:[7],peakText:"July\u2013August",dur:4,minHeightCm:30,maxHeightCm:90,minSpreadCm:15,maxSpreadCm:30,yearsToFlower:3,yearsToFlowerText:"3\u20135 years",attr:["butterfly"],nfix:false,colonizer:null,zone:"climax",feed:"humus",moist:"moist",benefit:"Saskatchewan's floral emblem; flame-coloured. Resents vigorous neighbours - keep in the climax zone."},
 {id:"bergamot",common:"Bergamot",sci:"Monarda fistulosa",color:"purple",bloom:[7,8],peak:[7],peakText:"July\u2013August",dur:8,minHeightCm:60,maxHeightCm:120,minSpreadCm:60,maxSpreadCm:90,yearsToFlower:2,yearsToFlowerText:"2 years",attr:["hummingbird","butterfly","bee"],nfix:false,colonizer:"spreading",zone:"general",feed:"adaptable",moist:"mesic",benefit:"Premium nectar for hummingbirds and swallowtails; clumps spread by rhizome."},
 {id:"gaillardia",common:"Gaillardia",sci:"Gaillardia aristata",color:"yellow",bloom:[7,8,9],peak:[7,8],peakText:"July\u2013September",dur:10,minHeightCm:30,maxHeightCm:75,minSpreadCm:30,maxSpreadCm:60,yearsToFlower:1,yearsToFlowerText:"1\u20132 years",attr:["bee","butterfly"],nfix:false,colonizer:null,zone:"general",feed:"lean",moist:"dry",benefit:"Long-blooming, drought-tough daisies for native bees."},
 {id:"blackeyed",common:"Black-eyed Susan",sci:"Rudbeckia hirta",color:"yellow",bloom:[7,8],peak:[7,8],peakText:"July\u2013August",dur:6,minHeightCm:30,maxHeightCm:90,minSpreadCm:30,maxSpreadCm:60,yearsToFlower:1,yearsToFlowerText:"1\u20132 years",attr:["bee","butterfly"],nfix:false,colonizer:null,zone:"buffer",feed:"adaptable",moist:"mesic",benefit:"Fast pioneer that establishes rapid floral cover."},
 {id:"purpleclover",common:"Purple Prairie Clover",sci:"Dalea purpurea",color:"purple",bloom:[7,8,9],peak:[7,8],peakText:"July\u2013September",dur:8,minHeightCm:30,maxHeightCm:90,minSpreadCm:30,maxSpreadCm:45,yearsToFlower:2,yearsToFlowerText:"2 years",attr:["bee","butterfly"],nfix:true,colonizer:null,zone:"buffer",feed:"lean",moist:"dry",benefit:"Nitrogen-fixer and premium pollen source; taproot cracks hardpan."},
 {id:"whiteclover",common:"White Prairie Clover",sci:"Dalea candida",color:"white",bloom:[7,8,9],peak:[7,8],peakText:"July\u2013September",dur:8,minHeightCm:30,maxHeightCm:90,minSpreadCm:30,maxSpreadCm:60,yearsToFlower:2,yearsToFlowerText:"2 years",attr:["bee","butterfly"],nfix:true,colonizer:null,zone:"general",feed:"lean",moist:"dry",benefit:"Nitrogen-fixer; blooms just after its purple sister species."},
 {id:"coneflower",common:"Prairie Coneflower",sci:"Ratibida columnifera",color:"yellow",bloom:[7,8,9],peak:[7,8],peakText:"July\u2013September",dur:10,minHeightCm:30,maxHeightCm:90,minSpreadCm:30,maxSpreadCm:60,yearsToFlower:1,yearsToFlowerText:"1\u20132 years",attr:["bee","butterfly"],nfix:false,colonizer:null,zone:"general",feed:"lean",moist:"dry",benefit:"Drought-resistant; draws a diverse guild of insects."},
 {id:"meadowblazing",common:"Meadow Blazingstar",sci:"Liatris ligulistylis",color:"purple",bloom:[7,8],peak:[7],peakText:"July\u2013August",dur:6,minHeightCm:60,maxHeightCm:150,minSpreadCm:30,maxSpreadCm:50,yearsToFlower:3,yearsToFlowerText:"3 years",attr:["butterfly","bee"],nfix:false,colonizer:null,zone:"general",feed:"adaptable",moist:"mesic",benefit:"The ultimate Monarch magnet; worth the slow establishment."},
 {id:"goldenaster",common:"Hairy Golden Aster",sci:"Heterotheca villosa",color:"yellow",bloom:[7,8,9],peak:[7,8],peakText:"July\u2013September",dur:8,minHeightCm:15,maxHeightCm:60,minSpreadCm:25,maxSpreadCm:60,yearsToFlower:2,yearsToFlowerText:"2 years",attr:["bee","butterfly"],nfix:false,colonizer:"spreading",zone:"general",feed:"lean",moist:"dry",benefit:"Forms low golden mats on dry, sandy ground; self-seeds freely."},
 {id:"prairiesage",common:"Prairie Sage",sci:"Artemisia ludoviciana",color:"white",bloom:[7,8,9],peak:[7,8],peakText:"July\u2013September",dur:8,minHeightCm:30,maxHeightCm:90,minSpreadCm:60,maxSpreadCm:120,yearsToFlower:2,yearsToFlowerText:"2 years",attr:["butterfly"],nfix:false,colonizer:"aggressive",zone:"colonizer",feed:"lean",moist:"dry",benefit:"Silver foliar accent and Painted Lady host - but a strong rhizomatous spreader (effectively indefinite)."},
 {id:"pasturesage",common:"Pasture Sage",sci:"Artemisia frigida",color:"yellow",bloom:[6,7,8],peak:[7],peakText:"June\u2013August",dur:8,minHeightCm:10,maxHeightCm:45,minSpreadCm:30,maxSpreadCm:60,yearsToFlower:2,yearsToFlowerText:"2 years",attr:[],nfix:false,colonizer:null,zone:"general",feed:"lean",moist:"dry",benefit:"Fine silver foliage; extreme drought tolerance (wind-pollinated)."},
 {id:"dottedblazing",common:"Dotted Blazingstar",sci:"Liatris punctata",color:"purple",bloom:[8,9,10],peak:[9],peakText:"August\u2013October",dur:8,minHeightCm:30,maxHeightCm:75,minSpreadCm:25,maxSpreadCm:30,yearsToFlower:2,yearsToFlowerText:"2\u20133 years",attr:["butterfly","bee"],nfix:false,colonizer:null,zone:"general",feed:"lean",moist:"dry",benefit:"Deep taproot; vital late-season nectar into October. One of the shortest blazingstars."},
 {id:"smoothaster",common:"Smooth Aster",sci:"Symphyotrichum laeve",color:"purple",bloom:[8,9],peak:[8],peakText:"August\u2013September",dur:6,minHeightCm:60,maxHeightCm:120,minSpreadCm:30,maxSpreadCm:60,yearsToFlower:2,yearsToFlowerText:"2 years",attr:["bee","butterfly"],nfix:false,colonizer:null,zone:"general",feed:"adaptable",moist:"mesic",benefit:"Resilient late source of pollen and nectar; stays upright."},
 {id:"lindleyaster",common:"Lindley's Aster",sci:"Symphyotrichum ciliolatum",color:"purple",bloom:[8,9],peak:[8],peakText:"August\u2013September",dur:6,minHeightCm:30,maxHeightCm:120,minSpreadCm:30,maxSpreadCm:60,yearsToFlower:2,yearsToFlowerText:"2 years",attr:["bee","butterfly"],nfix:false,colonizer:"spreading",zone:"general",feed:"adaptable",moist:"mesic",benefit:"Performs well in partial / dappled shade; spreads by long rhizomes into colonies."},
 {id:"manyflower",common:"Many-Flowered Aster",sci:"Symphyotrichum ericoides",color:"white",bloom:[8,9,10],peak:[9],peakText:"August\u2013October",dur:8,minHeightCm:30,maxHeightCm:90,minSpreadCm:30,maxSpreadCm:60,yearsToFlower:2,yearsToFlowerText:"2 years",attr:["bee","butterfly"],nfix:false,colonizer:"spreading",zone:"general",feed:"lean",moist:"dry",benefit:"Profuse late bloom critical for late solitary bees; rhizomatous, can spread ~30 cm/year."},
 {id:"stiffgold",common:"Stiff Goldenrod",sci:"Solidago rigida",color:"yellow",bloom:[8,9,10],peak:[9],peakText:"August\u2013October",dur:8,minHeightCm:60,maxHeightCm:150,minSpreadCm:45,maxSpreadCm:75,yearsToFlower:2,yearsToFlowerText:"2 years",attr:["bee","butterfly"],nfix:false,colonizer:null,zone:"general",feed:"adaptable",moist:"mesic",benefit:"Flat-topped clusters carry heavy late-season insect loads. A tall plant (to ~1.5 m) and a heavy self-seeder."},
 {id:"canadagold",common:"Canada Goldenrod",sci:"Solidago canadensis",color:"yellow",bloom:[8,9,10],peak:[9],peakText:"August\u2013October",dur:8,minHeightCm:60,maxHeightCm:180,minSpreadCm:60,maxSpreadCm:90,yearsToFlower:2,yearsToFlowerText:"2 years",attr:["bee","butterfly"],nfix:false,colonizer:"aggressive",zone:"colonizer",feed:"adaptable",moist:"mesic",benefit:"High-yield autumn resource, but one of the most aggressive native colonizers - contain it firmly."},
 {id:"mountaingold",common:"Mountain Goldenrod",sci:"Solidago simplex",color:"yellow",bloom:[8,9,10],peak:[9],peakText:"August\u2013October",dur:8,minHeightCm:20,maxHeightCm:80,minSpreadCm:30,maxSpreadCm:60,yearsToFlower:2,yearsToFlowerText:"2 years",attr:["bee","butterfly"],nfix:false,colonizer:null,zone:"general",feed:"lean",moist:"dry",benefit:"The best-behaved goldenrod here; compact, clump-forming front-of-border plant."}
];
